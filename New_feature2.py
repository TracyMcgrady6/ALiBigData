...
user_pay_id_1 = pd.DataFrame(user_pay_id_1,
                             columns=['date', 'count', 'V1',
                                      'V2_day2_count', 'V3_day3_count', 'V4_day4_count', 'V5_day5_count',
                                      'V6_day6_count',
                                      'V7_day7_count', 'V8_day8_count', 'V9_day9_count', 'V10_day10_count',
                                      'V11_day11_count', 'V12_day12_count',
                                      'V13_day13_count', 'V14_day14_count',
                                      'V15_day2_mean', 'V16_day3_mean', 'V17_day4_mean','V5_day7_mean', 'V6_day14_mean', 'V7_day21_mean', 'V8_day30_mean', 'V9_day2_min',
                                      ...
                                      'V20_day14_std', 'V21_day21_std', 'V22_day30_std', 'V23_day2_count',
                                      'V23_day3_count', 'V24_day4_count', 'V25_day5_count', 'V26_day6_count',
                                      'V27_day7_count', 'Mon', 'Tues', 'Wed', 'Thur',
                                      'Fri', 'Sat', 'Sun'])
user_pay_id_1 = user_pay_id_1.drop(['date'], axis=1)
day_gaps = [-1, -2, -3, -4, -5, -6, -7, -14, -21, -30]
